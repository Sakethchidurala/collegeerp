...
const AdminAddAdmin = () => {
    ...
    const formHandler = (e) => {
        e.preventDefault()
        setIsLoading(true)
        if(!ifStringIsNumber(contactNumber)){
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input onChange={(e) => setEmail(e.target.value)} required  type="email" className={classnames("form-control",
                                                {
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input onChange={(e) => setContactNumber(e.target.value)} type="text" maxLength='10' minLength="10" className={classnames("form-control",
                                                {
