                            ...
                            <div className="col-md-5 w-100 m-auto">
                                <form onSubmit={formHandler}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input onChange={(e) => setContactNumber(e.target.value)} required type="text" maxLength="10" minLength="10" className="form-control" id="numberId" />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="fatherId">Father Name</label>
                                        <input onChange={(e) => setFatherName(e.target.value)} required type="text" className="form-control" id="fatherId" />
                                    </div>
                                    <div className="form-group">
